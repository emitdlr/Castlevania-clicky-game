...
const characters = ['Gabriel', 'Eric', 'Soma', 'Gauntlet Gabriel', 'Issac', 'William', 'Alucard with Sword', 'Simon', 'Alucard', 'Issac', 'Happy Dracula', 'Angry Dracula', 'Camilla', 'Angry Camilla', 'Toy Maker', 'Hector'];
